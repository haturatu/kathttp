...
public:
  ...
  bool recv_stream_data(uint32_t flags, int64_t stream_id, const uint8_t *data,
                         size_t len, bool fin, ngtcp2_tstamp ts);
  ...
  bool ready() const { return httpconn_ != nullptr; }
